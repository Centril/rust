...
fn trait_def(tcx: TyCtxt<'_>, def_id: DefId) -> &ty::TraitDef {
    ...
    if paren_sugar && !tcx.features().active(sym::unboxed_closures) {
                ...
                let kind = match param.kind {
                    GenericParamKind::Type {
                        ...
                        if !allow_defaults && default.is_some() {
                            if !tcx.features().active(sym::default_type_parameter_fallback) {
                                tcx.lint_hir(
    ...
    match tcx.hir().get(hir_id) {
        ...
        Node::GenericParam(param) => match &param.kind {
            ...
            hir::GenericParamKind::Const { ty: ref hir_ty, .. } => {
                ...
                if !tcx.features().active(sym::const_compare_raw_pointers) {
...
fn compute_sig_of_foreign_fn_decl<'tcx>(
    ...
    if abi != abi::Abi::RustIntrinsic
        ...
        && !tcx.features().active(sym::simd_ffi)
    {
...
fn from_target_feature(
    ...
    for item in list {
        ...
        target_features.extend(value.as_str().split(',').filter_map(|feature| {
            ...
            match feature_gate.as_ref().map(|s| *s) {
