...
pub use self::error::{
    struct_error, CheckInAllocMsg, ConstEvalRawResult, ConstEvalResult, ErrorAndBacktrace,
    ErrorHandled, InterpError, InterpResult, InvalidProgramInfo, MachineStopType,
